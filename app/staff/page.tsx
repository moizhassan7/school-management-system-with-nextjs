  ...
  return (
    <div className="page-content mx-auto w-full max-w-[1600px] space-y-6">
      ...
      <div className="bento-grid">
        <div className="bento-tile bento-tile-featured flex flex-col justify-between p-5">
          ...
          <div>
            ...
            <h3 className="mt-1 font-heading text-3xl font-bold text-white">{total}</h3>
          </div>
        </div>
      ...
      {loading ? (
        ...
        <EmptyState
          title={debouncedSearch ? 'No staff match your search' : 'No staff members yet'}
          description={
            debouncedSearch
              ? 'Try a different name or designation.'
              : 'Add your first staff member to get started.'
          }
          actionLabel={debouncedSearch ? undefined : 'Add Staff'}
          actionHref={debouncedSearch ? undefined : '/staff/new'}
        />
      ) : (
        <>
